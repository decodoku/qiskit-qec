...
def get_stim_circuits(
    ...
    detectors: Union[List[Dict], List[List]] = None,
    logicals: Union[List[Dict], List[List]] = None,
):
...
def detector_error_model_to_rx_graph(
    ...
    Args:
        model: stim detector error model
        detectors: if specified, supply a list of qubits with a time
...
def string2nodes_with_detectors(
    ...
    **kwargs,
    ...
    Args:
        ...
        detectors: A list of measurement comparisons.
        logicals:
        clbits:
        det_ref_values:
